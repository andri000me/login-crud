...
<?php if (!empty($_SESSION['ADMIN'])) { ?>
  <div class="container-fluid">
    <div class="alert alert-info alert-dismissible">
      ...
      Klik tambah untuk menginput customer baru
    </div>
    <div class="row">
      <div class="col-12">
        <!-- /.card -->
        <div class="card">
          ...
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php
                $api_categories_list = $api_url . '/customers/list.php';
                ...
                ?>
                  <tr>
                    ...
                    <td><?= $arr['alamat']; ?></td>
                    <td>
                      <a href="<?= $abs; ?>/backend/pages/index.php?page=customers-form&act=edit&id=<?= $arr['id']; ?>" class="btn btn-success btn-sm"><span class="fa fa-edit"></span></a>
                      <a onclick="return confirm('Apakah yakin data akan di hapus?')" href="<?= $abs; ?>/backend/pages/customers/crud.php?act=hapus&id=<?= $arr['id']; ?>" class="btn btn-danger btn-sm"><span class="fa fa-trash"></span></a>
