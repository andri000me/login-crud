...
<?php if (!empty($_SESSION['ADMIN'])) { ?>
  <div class="container-fluid">
    <div class="alert alert-info alert-dismissible">
      ...
      Sebelum menginput site survey, terlebih dulu harus menginput <a href="<?=$abs;?>/backend/pages/index.php?page=customers-form&act=tambah">customer</a><br>
      Klik tambah untuk menginput site survey baru
    </div>
