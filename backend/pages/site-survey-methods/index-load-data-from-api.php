        ...
        <div class="card">
          ...
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php
                $api_categories_list = $api_url . '/site-survey-methods/list.php';
                ...
                ?>
                  <tr>
                    <td><?= $no; ?></td>
                    <td><?= $arr['nama_survey']; ?></td>
                    <td><?= $arr['nama_methods']; ?></td>
                    <td>
                      <a href="<?= $abs; ?>/backend/pages/index.php?page=site-survey-methods-form&act=edit&id=<?= $arr['id']; ?>" class="btn btn-info btn-sm">
                        <i class="fas fa-pencil-alt">
                        </i>
                      </a>
                      <a onclick="return confirm('Apakah yakin data akan di hapus?')" href="<?= $abs; ?>/backend/pages/site-survey-methods/crud.php?act=hapus&id=<?= $arr['id']; ?>" class="btn btn-danger btn-sm">
