				...
				<div class="card">
					...
					<div class="card-body">
						<table id="example1" class="table table-bordered table-striped">
							...
							<tbody>
								<?php
								$api_categories_list = $api_url_morillo . '/4dMinMrl/api/news/list.php';
								...
								?>
									<tr>
										...
										<td><?= $arr['nama']; ?></td>
										<td>
											<img src="<?= $api_url_morillo; ?>/images/news/<?= $arr['acak1']; ?>" height="40">
										</td>
										<td>
											<a href="<?= $abs; ?>/backend/pages/index.php?page=news-detail&id=<?= $arr['id']; ?>" class="btn btn-primary btn-sm">
