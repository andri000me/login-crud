...
$query = $datatable->get_custom("SELECT * from tbl_job_status as s", $columns);
...
foreach ($query	as $value) {
	...
	<a href=\"" . $abs . "/backend/pages/index.php?page=job-status-form&act=edit&id=" . $value->id . "\" class=\"btn btn-success btn-sm\"><span class=\"fa fa-edit\"></span></a>
	<a onclick=\"return confirm('Apakah yakin data akan di hapus?')\" href=\"" . $abs . "/backend/pages/job-status/crud.php?act=hapus&id=" . $value->id . "\" class=\"btn btn-danger btn-sm\"><span class=\"fa fa-trash\"></span></a>";
