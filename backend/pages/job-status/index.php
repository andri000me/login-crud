				...
				<div class="card">
					...
					<div class="card-body">
						<table id="example1" class="table table-bordered table-striped">
							...
							<tbody>
								<?php
								$api_categories_list = $api_url . '/status/list.php';
								...
								?>
									<tr>
										...
										<td><?= $arr['nama']; ?></td>
										<td>
											<a href="<?= $abs; ?>/backend/pages/index.php?page=job-status-form&act=edit&id=<?= $arr['id']; ?>" class="btn btn-success btn-sm"><span class="fa fa-edit"></span></a>
											<a onclick="return confirm('Apakah yakin data akan di hapus?')" href="<?= $abs; ?>/backend/pages/job-status/crud.php?act=hapus&id=<?= $arr['id']; ?>" class="btn btn-danger btn-sm"><span class="fa fa-trash"></span></a>
