...
$hasil = $proses->tampil_data_id('tbl_job_status', 'id', $idGet);
?>
      ...
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-header">
            <h4 class="card-title"><?= $_GET['act']; ?> job status - <?php echo $hasil['nama']; ?></h4>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <form action="<?= $abs; ?>/backend/pages/job-status/crud.php?act=<?= $_GET['act']; ?>" method="POST">
              <div class="row">
