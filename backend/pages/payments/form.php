...
$hasil = $proses->tampil_data_id('tbl_payments', 'id', $idGet);
?>
      ...
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-header">
            <h4 class="card-title"><?= $_GET['act']; ?> <?=$data['title'];?> / <?php echo $hasil['nama']; ?></h4>
          </div>
          <div class="card-body">
            <!-- form berfungsi mengirimkan data input 
						dengan method post ke proses crud dengan paramater get aksi edit -->
            <form id="quickForm" action="<?= $abs; ?>/backend/pages/payments/crud.php?act=<?= $_GET['act']; ?>" method="POST">
              <div class="row">
