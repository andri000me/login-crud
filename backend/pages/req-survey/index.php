    ...
    <div class="card">
      ...
      <div class="card-body">
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
            <?php
            $api_categories_list = $api_url . '/req-survey/list.php';
            ...
            ?>
              <tr>
                ...
                <td>
                  <a href="<?= $abs; ?>/backend/pages/index.php?page=req-survey-detail&id=<?= $arr['id']; ?>" class="btn btn-primary btn-sm">
                    <i class="fas fa-folder">
                    </i>
                  </a>
                  <a href="<?= $abs; ?>/backend/pages/index.php?page=req-survey-form&act=edit&id=<?= $arr['id']; ?>" class="btn btn-info btn-sm">
                    <i class="fas fa-pencil-alt">
                    </i>
                  </a>
                  <a onclick="return confirm('Apakah yakin data akan di hapus?')" href="<?= $abs; ?>/backend/pages/req-survey/crud.php?act=hapus&id=<?= $arr['id']; ?>" class="btn btn-danger btn-sm">
